...
class _FacultyPageState extends State<FacultyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    ? sec_color = Color.fromRGBO(0, 79, 0, 0.3)
    : sec_color = Colors.black12;
                                                      ...
                                                      if (item.get(
                                                        ...
                                                        Column(
                                                          children: [
                                                            ...
                                                            if (item.get(
                                                                    'trainingDuration_full_correspondence') !=
                                                                '')
                                                              Text(
                                                                item.get(
                                                                    'trainingDuration_full_correspondence'),
                                                      ...
                                                      if (item.get(
                                                        ...
                                                        Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            if (item.get(
                                                                    'trainingDuration_short_correspondence') !=
                                                                '')
                                                              Text(
                                                                item.get(
                                                                    'trainingDuration_short_correspondence'),
                                        ...
                                        if (item.get('entranceTests_full') !=
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                    'Вступительные испытания (полное):'),
                                                Text(
                                                  item.get(
                                                      'entranceTests_full'),
                                                  style: TextStyle(
                                        ...
                                        if (item.get('entranceTests_short') !=
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                    'Вступительные испытания (сокращенное):'),
                                                Text(
                                                  item.get(
                                                      'entranceTests_short'),
                                                  style: TextStyle(
